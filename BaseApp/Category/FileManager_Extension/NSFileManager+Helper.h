...
//  FirstVideo
//
//  Created by leku on 14-7-9.
//  Copyright (c) 2014年 leku. All rights reserved.
//
...
/**
 ...
 @return 是否保存成功
 */
+ (BOOL)pp_saveData:(NSData *)data filePath:(NSString *)filePath;
...
/**
 ...
 @return 二进制
 */
+ (UIImage *)pp_getImageFileName:(NSString *)filePath;
